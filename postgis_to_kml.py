...
year = 2016
feature = 'li_map'
print('ogr2ogr -f KML {feature}_{locale}_{year}.kml "PG:host=localhost dbname=observatory user=postgres password=***REMOVED***" {feature}_{locale}_{year}  -s_srs EPSG:7845 -t_srs EPSG:4326'.format(feature = feature, locale = locale, year = year))  
