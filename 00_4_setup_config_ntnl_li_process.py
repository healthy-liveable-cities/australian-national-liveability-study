...
configured = false
if configured == false:
  print('''Please set up the project configuration file (config_ntnl_li_process.py.  If it has already exists and has been set up appropriately for your study region, ensure the variable 'configured' is set to equal 'true'.''')
