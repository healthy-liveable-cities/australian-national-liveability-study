...
ad_hoc_destinations = ['gtfs_20191008_20191205_bus_0015',
                       'gtfs_20191008_20191205_bus_0030',
                       'gtfs_20191008_20191205_bus_0045',
                       'gtfs_20191008_20191205_bus_any',
                       'gtfs_20191008_20191205_ferry_0015',
                       'gtfs_20191008_20191205_ferry_0030',
                       'gtfs_20191008_20191205_ferry_0045',
                       'gtfs_20191008_20191205_ferry_any',
                       'gtfs_20191008_20191205_train_0015',
                       'gtfs_20191008_20191205_train_0030',
                       'gtfs_20191008_20191205_train_0045',
                       'gtfs_20191008_20191205_train_any',
                       'gtfs_20191008_20191205_tram_0015',
                       'gtfs_20191008_20191205_tram_0030',
                       'gtfs_20191008_20191205_tram_0045',
...
od_distances  = "od_closest_20191129"
log_table    = "log_od_distances_20191129"
...
def ODMatrixWorkerFunction(hex): 
  ...
  try:    
    ...
    # Report on progress
    curs.execute("SELECT count(*) FROM od_closest_20191129 WHERE dest_name IN (SELECT dest_name FROM dest_type);".format(log_table))
...
if __name__ == '__main__':
  ...
  sql = '''
  INSERT INTO od_closest_20191129 ({id},dest_class,dest_name,oid,distance,threshold,ind_hard,ind_soft)  
    SELECT c.{id}                                                                           ,
        c.dest_class                                                                     ,
        t.dest_name                                                                      ,
        -999 AS oid                                                                      ,
    ...
    FROM (SELECT {id},
            ...
            FROM od_distances_3200m_20191129 a
        WHERE NOT EXISTS (SELECT 1 
                            FROM od_closest_20191129 c 
