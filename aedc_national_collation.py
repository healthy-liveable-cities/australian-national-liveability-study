...
for locale in sorted(study_regions, key=str.lower):
  ...
  if locale in processed_locales:
    ...
    print((" - {:"+str(locale_field_length)+"}:").format(locale)),
...
FROM aedc_aifs_linked)
TO 'D:/ntnl_li_2018_template/data/study_region/aedc/aedc_aifs_linked_simple_stata_20190621.csv' 
