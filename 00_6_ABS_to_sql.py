# Script:  00_6_ABS_to_sql.py
# Purpose: Copy processed data from JA ABS tables processed in Knime to project database         
# Author:  Carl Higgs
# Date:    20180605


#### NOTE: This is all old code, currently retained as a place holder.  
###        Previously these statistics were calculated using earlier / subsequent scripts.
###        This script will now have the role of importing the externally processed sumamries
###        so that they can be matched up with address data and summarised as required.
